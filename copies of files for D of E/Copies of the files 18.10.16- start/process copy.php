 	...
 	while($row = mysqli_fetch_assoc($result)){
 		...
 		if($decrypt){
          ...
          $_SESSION['user'] = $loginU;
           ...
           header("Location:http://localhost/Web%20Dev%20/login%20Project/access.php?form=Logined");
...
header('http://localhost/Web%20Dev%20/login%20Project/send.php?form=Failed_Login');
...
checksLog('username','password',"",true,1,"form","_username","_password");               
